...
export const posts: Post[] = [
...

  {
    ...
    blocks: [
      ...
      { t: "p", c: "La loi vise à accroître la participation des nationaux et des entreprises à capitaux majoritairement congolais dans l'ensemble des chaînes de valeur de l'économie. Elle poursuit un double objectif affiché : favoriser l'émergence d'une classe moyenne congolaise et créer des champions nationaux capables de rivaliser à l'échelle régionale et internationale." },
      { t: "h2", c: "Un nouveau cadre institutionnel : l'ARCLOC" },
      { t: "p", c: "La loi crée l'Autorité de Régulation du Contenu Local du Congo (ARCLOC), dotée de pouvoirs étendus : délivrance des agréments, validation des plans triennaux, contrôle sur pièces et sur place, et application des sanctions. L'ARCLOC est l'interlocuteur unique pour toutes les obligations de Contenu local." },
      { t: "h2", c: "Des obligations structurantes pour les entreprises" },
      { t: "h3", c: "Plan triennal du Contenu local" },
      { t: "p", c: "Chaque entreprise doit élaborer un plan triennal du Contenu local, le soumettre à l'ARCLOC pour approbation, et rendre compte annuellement de son exécution. Ce plan couvre les achats locaux, l'emploi, le transfert de technologies et la participation au capital." },
      { t: "h3", c: "Approvisionnement local" },
      { t: "p", c: "Les entreprises doivent s'approvisionner en priorité en biens et services produits ou transformés sur le territoire national. Les grandes surfaces commerciales doivent réserver un espace dédié aux produits locaux." },
      { t: "h3", c: "Zone exclusive de 51 % pour les marchés publics" },
      { t: "ul", items: [
        "51 % des marchés publics réservés aux entreprises à capitaux et direction congolais",
        "Applicable progressivement : 25 % la 1re année, 51 % dès la 2e année",
        "Responsabilité personnelle du Directeur général en cas de non-respect répété",
      ]},
      { t: "h3", c: "Emploi et formation" },
      { t: "p", c: "Les emplois non qualifiés sont réservés exclusivement aux Congolais, en priorité aux résidents des communautés locales. Pour les postes qualifiés et de direction, chaque entreprise doit réserver, dans un délai de 3 ans, au moins 80 % des emplois aux nationaux." },
      { t: "h3", c: "Transfert de technologies" },
      { t: "p", c: "Toute entreprise étrangère opérant dans un secteur stratégique doit soumettre un plan de transfert de technologies. Les contrats publics et privés dépassant un seuil réglementaire doivent obligatoirement inclure un volet transfert de technologies et renforcement des capacités locales." },
      { t: "h2", c: "Participation obligatoire au capital social" },
      { t: "p", c: "C'est l'une des mesures les plus structurantes : toute entreprise du secteur privé doit garantir une participation minimale de personnes physiques de nationalité congolaise dans son capital social, avec un seuil additionnel de 5 % réservé aux travailleurs congolais. Les seuils varient selon le secteur d'activité :" },
      { t: "ul", items: [
        "Mines et hydrocarbures : 8 % minimum (+ 5 % travailleurs)",
        "Télécommunications, banques, assurances : 25 % minimum (+ 5 % travailleurs)",
        "Commerce de détail et gros : 51 % minimum (+ 5 % travailleurs)",
        "Activités réservées exclusivement aux nationaux : 100 %",
      ]},
      { t: "p", c: "Les modalités précises de mise en œuvre seront fixées par décret du Premier ministre. Une participation additionnelle de 5 % au profit des travailleurs congolais s'applique de manière constante dans la quasi-totalité des secteurs listés." },
      { t: "h2", c: "Un régime de sanctions dissuasif" },
      { t: "p", c: "Le non-respect des obligations expose les entreprises à un éventail de sanctions administratives et pénales :" },
      { t: "ul", items: [
        "100 à 500 millions de FC pour défaut ou retard de rapport annuel d'exécution du plan triennal",
        "500 millions à 1 milliard de FC pour défaut de soumission ou fausses déclarations dans le plan triennal",
        "500 millions à 1 milliard de FC pour non-exécution totale du plan approuvé (doublés en cas de récidive)",
        "1 à 2 milliards de FC et mise sous scellés ou fermeture temporaire pour défaut persistant d'ouverture du capital",
        "Jusqu'à 5 ans d'emprisonnement pour les agents de l'ARCLOC coupables de corruption",
      ]},
      { t: "h2", c: "Ce que cela signifie pour votre entreprise" },
      { t: "p", c: "Pour les filiales et groupes internationaux opérant en RDC, cette loi impose une revue immédiate de trois dimensions :" },
      { t: "ul", items: [
        "Structure capitalistique : vérifier les seuils applicables à votre secteur et anticiper les cessions de parts",
        "Politique d'achat local : identifier les fournisseurs locaux qualifiés et réviser les contrats d'approvisionnement",
        "Plan de recrutement : mettre en conformité la politique RH avec les quotas d'emploi à 3 ans",
      ]},
